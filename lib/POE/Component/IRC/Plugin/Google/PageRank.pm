...
Please report any bugs or feature requests to C<bug-poe-component-irc-plugin-google-pagerank at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-IRC-Plugin-Google-PageRank>.  I will be notified, and then you'll
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc POE::Component::IRC::Plugin::Google::PageRank
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-IRC-Plugin-Google-PageRank>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-IRC-Plugin-Google-PageRank>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-IRC-Plugin-Google-PageRank>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-IRC-Plugin-Google-PageRank>
